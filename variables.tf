variable settings {
  ...
  default = {
    ...
    "production.ec2_volume_size"   = 30                      // expect size >= 30GB
    "staging.ec2_volume_size"      = 30                      // expect size >= 30GB
    "production.ec2_instance_ami"  = "ami-0934e28fe3e390537" # Amazon ECS-optimized AMI, Amazon Linux 2 AMI (HVM), SSD Volume Type x86 (ap-northeast-1)
    "staging.ec2_instance_ami"     = "ami-0934e28fe3e390537" # Amazon ECS-optimized AMI, Amazon Linux 2 AMI (HVM), SSD Volume Type x86 (ap-northeast-1)
    "production.public_key_path"   = "./terraform-sample-05.pub"
    "staging.public_key_path"      = "./terraform-sample-05.pub"
    ...
    # ECS Settings
    "ecr_repository_name"                   = "terraform-sample-05"
    "ecs_service_name"                      = "terraform-sample-05-service"
    "ecs_task_container_name"               = "terraform-sample-05-continer"
    "production.ecs_task_desired_count"     = 2
    "staging.ecs_task_desired_count"        = 1
    "production.ecs_task_cpu"               = 512
    "staging.ecs_task_cpu"                  = 256
    "production.ecs_task_memoryReservation" = 512
    "staging.ecs_task_memoryReservation"    = 256
    "production.ecs_log_retention_in_days"  = 30
    "staging.ecs_log_retention_in_days"     = 7
